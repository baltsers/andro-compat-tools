...
#name=file_name("/home/zyzhang/AndroZoo/2017")
name=file_name("/home/zyzhang/VirusShare/2016")
fa=open("/home/zyzhang/name-malmare-2016.txt","w")
...
max_version=[]
max_old=[]
#fb=open("/home/zyzhang/malware-2010maxsdk","w")
for i in range(len(name)):
    cmd="getmaxsdk.sh "+name[i]
#    cmd="getminsdk.sh "+name[i]
#    cmd="gettargetsdk.sh "+name[i]

    sdk_max=os.system(cmd)
    #fb.write(str(sdk_max))
    #subprocess.Popen("cmd",stdout= fb).wait()
